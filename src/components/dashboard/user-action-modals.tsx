...
const UserActionModals = ({
  ...
  const [sendNotification, { isLoading, isError }] =
    useAdminSendUserNotificationMutation();
  const {
    control,
    handleSubmit,
  ...
  return (
    <>
      ...
      >
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button
              variant={user.isIpBan ? 'default' : 'destructive'}
              onClick={handleBan}
            >
      ...
      <Dialog
        open={actionType === 'suspend' || actionType === 'Unsuspend'}
        onOpenChange={onClose}
      >
        <DialogContent>
          <DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button
              variant={user.isSuspend ? 'default' : 'destructive'}
      ...
      <Dialog open={actionType === 'force-logout'} onOpenChange={onClose}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              This will send a password reset email to {user.email} and force
      ...
      <Dialog open={actionType === 'subscription'} onOpenChange={onClose}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Change the subscription plan for {user.name}. Current plan:{' '}
      ...
      <Dialog open={actionType === 'notes'} onOpenChange={onClose}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Add an administrative note for a user. This will be visible to
