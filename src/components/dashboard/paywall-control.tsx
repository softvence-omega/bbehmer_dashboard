...
const PaywallControl = () => {
  ...
  const [deletePaywall, { isLoading: isDeleting }] =
    useAdminPaywallControlDeleteMutation();
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {features.filter((f: any) => f.plan === 'pro').length}
            </div>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {features.filter((f: FeatureFlagFormData) => f.enabled).length}
            </div>
          </CardContent>
        </Card>
        {/* <Card>
                ...
                {features.map((feature: FeatureFlagFormData) => (
                  <TableRow key={feature.id}>
                    ...
                    <TableCell>
                      <Badge
                        variant={
                          feature.plan === 'free' ? 'outline' : 'default'
                        }
                      >
                        {feature.plan === 'free' ? 'Free' : 'Paid'}
                      </Badge>
                    </TableCell>
                    <TableCell>
