...
const NotificationsList = () => {
  ...
  const {
    ...
    error,
    refetch,
  } = useAdminGetAllNotificationsQuery({ limit, offset });
  ...
  const totalPages = notificationsData
    ? Math.ceil(notificationsData?.data?.total / limit)
    : 0;
  // const allSelected =
    ...
    <div className="space-y-6 p-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="text-sm text-gray-400">
          Total: {notificationsData?.data?.length || 0} notifications
        </div>
      </div>
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent className="bg-gray-900 border-gray-800">
                      ...
                      <AlertDialogFooter>
                        ...
                        <AlertDialogAction
                          onClick={() =>
                            handleDelete(notification?.notification?.id)
                          }
                          disabled={isDeleting}
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between bg-gray-900 border border-gray-800 rounded-lg p-4">
          <div className="text-sm text-gray-400">
            Showing {offset + 1} to{' '}
            {Math.min(offset + limit, notificationsData?.total || 0)} of{' '}
