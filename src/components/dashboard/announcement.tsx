...
const AnnouncementPage = () => {
  ...
  const [adminAnnounce, { isLoading: isMutating }] =
    useAdminAnnoucementMutation();
  const {
    register,
    handleSubmit,
            ...
            <div className="flex justify-between items-center w-full">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Link to="/dashboard/admin/all-announcement">
                  <Button
                    variant={'link'}
                    className="px-1 py-1 text-white text-right"
                  >
                    See All
                  </Button>
                </Link>
                      ...
                      {announcement.startsAt && announcement.endsAt && (
                        <div className="mt-4 pt-4 border-t border-gray-800">
                          <div className="flex items-center gap-4 text-sm text-gray-400">
                            <span>
                              Active:{' '}
                              {new Date(announcement.startsAt).toDateString()}
                            </span>
                            <span>
                              Until:{' '}
                              {new Date(announcement.endsAt).toDateString()}
                            </span>
                          </div>
                        </div>
                      )}
