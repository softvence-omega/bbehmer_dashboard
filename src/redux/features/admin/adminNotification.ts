...
const adminNotification = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    adminGetAllAnnouncements: builder.query<
      any,
    ...
    adminGetAllNotification: builder.query<
      any,
      { limit?: number; offset?: number }
    >({
      query: ({ limit = 10, offset = 0 } = {}) => ({
    ...
    adminGetAllIdBan: builder.query<
      any,
      { skip?: number; take?: number; ip?: string }
    >({
...
export const {
  useAdminPaywallControlDeleteMutation,
  useAdminPaywallControlUpdateMutation,
  useAdminPaywallControlMutation,
  useAdminpaywallControlQuery,
  useAdminGetLogQuery,
  ...
  useAdminSendUserNotificationMutation,
  useAdminAnnoucementMutation,
  useAdminGetAllAnnouncementsQuery,
  useDeleteAnnouncementMutation,
  useUpdateAnnouncementMutation,
  useAdminGetAllNotificationQuery,
} = adminNotification;
