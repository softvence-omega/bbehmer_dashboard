...
import { Loader2, Mail, Lock, KeyRound, ArrowLeft, CheckCircle, AlertCircle } from "lucide-react"
          ...
          <div className="flex items-center space-x-4">
            ...
            <div
              className={`w-12 h-0.5 ${
                currentStep === "reset" || currentStep === "success" ? "bg-green-600" : "bg-gray-300"
              }`}
            />
            <div
              className={`flex items-center justify-center w-8 h-8 rounded-full text-sm font-medium ${
          ...
          <>
            ...
            <CardContent>
              <form onSubmit={emailForm.handleSubmit(onSendCode)} className="space-y-4">
                ...
                <Button type="submit" className="w-full" disabled={!emailForm.formState.isValid || isLoading}>
                  {isLoading ? (
                    <>
        ...
        {currentStep === "reset" && (
          <>
            <CardHeader className="space-y-1">
              ...
              <CardDescription className="text-center">
                Enter the verification code sent to {userEmail} and your new password
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={resetForm.handleSubmit(onResetPassword)} className="space-y-4">
                ...
                <div className="space-y-2">
                  <Button type="submit" className="w-full" disabled={!resetForm.formState.isValid || isLoading}>
                    {isLoading ? (
                      <>
                        <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                        Resetting Password...
